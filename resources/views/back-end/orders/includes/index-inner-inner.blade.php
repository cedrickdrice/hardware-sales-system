            ...
            <div class="col-sm-3">
                <div class="d-flex w-100 justify-content-center align-items-center h-100">
                    <div class="align-self-center">
                        <img src="{{asset('storage/products/' . $order_detail->product->image)}}" height="100px">
                    </div>
                </div>
            </div>
            <div class="col-sm-9">
                <h2 class="mb-0">{{$order_detail->product->name}}</h2>
                <p class="text_grayish text-uppercase"><sup>{{$order_detail->product->category->name}}</sup></p>
